...
format: 
    revealjs:
        ...
        smaller: true
        scrollable: true
>>>>>>> ab77ec6 (update workshop slides)
---
...
2. **Python packages for clinical reporting (Yilong)**: A guided tour of essential packages such as `polars`, and `rtflite`, with demonstrations of creating TLFs commonly used in clinical trials.
...
=======
Examples: 
- Data manipulation: polars, rtflite.
- ADaM data: `adsl`, `adae` etc.
>>>>>>> ab77ec6 (update workshop slides)
...
=======
- During the workshop, we will use [pycsr](https://github.com/nanxstats/pycsr) and [demo-py-esub](https://github.com/elong0527/demo-py-esub) project.
>>>>>>> ab77ec6 (update workshop slides)
...
```
=======
rtflite provides a Python classes `RTFDocument` that map to table elements.
