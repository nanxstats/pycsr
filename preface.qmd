...
- Part 2, titled "Reporting packages" introduces key packages like Polars for data manipulation and rtflite for creating
  ...
  [Python Polars: The Definitive Guide](https://polarsguide.com/), the
  [Polars user guide](https://docs.pola.rs/user-guide/getting-started) and the
  [rtflite documentation](https://rtflite.readthedocs.io/).

- Part 3, titled "Delivering TLFs in CSR", provides general information and
...
- Part 4, titled "Clinical trial project", provides general information and
...
- Part 5, titled "eCTD submission package", provides general information on
